...
_FACTORY = {
    ...
    "dense1d": lambda params: ModelDense([('D', 0.1), ('L', params["embd_size"], params["classes_count"])]),
    "dense2": lambda params: ModelDense([('L', params["embd_size"], 64), ('L', 64, params["classes_count"])]),
    "dense2d": lambda params: ModelDense([('L', params["embd_size"], 64), ('D', 0.1), ('L', 64, params["classes_count"])]),
    "dense3": lambda params: ModelDense([('L', params["embd_size"], 64), ('L', 64, 64), ('L', 64, params["classes_count"])]),
    "dense3d": lambda params: ModelDense([('L', params["embd_size"], 64), ('D', 0.1), ('L', 64, 64), ('D', 0.1), ('L', 64, params["classes_count"])]),
